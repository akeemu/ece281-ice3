...
## Images
![Screenshot of the waveform from the simulation of the ripple adder testbench](waveform.png)

![Screenshot of the quick sketch of the entity](entitySketch.png)
